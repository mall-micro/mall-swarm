...
CREATE TABLE `pms_album`  (
    ...
    `cover_pic` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `pms_album_pic`  (
    ...
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '相册图片表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `pms_brand`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 60 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '品牌表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `pms_comment`  (
    ...
    `member_ip` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '评价的ip',
    `create_time` datetime DEFAULT NULL,
    `show_status` int(1) DEFAULT NULL,
    `product_attribute` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '购买时的商品属性',
    `collect_couont` int(11) DEFAULT NULL,
    `read_count` int(11) DEFAULT NULL,
    `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
    `pics` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '上传图片地址，以逗号隔开',
    `member_icon` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '评论用户头像',
...
CREATE TABLE `pms_feight_template`  (
    ...
    `dest` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '目的地（省、市）',
    PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `pms_member_price`  (
    ...
    `member_level_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 426 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品会员价格表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `pms_product`  (
    ...
    `detail_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
    ...
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 46 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品信息' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `pms_product_attribute`  (
    ...
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 74 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品属性参数表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `pms_product_attribute_category`  (
   ...
   PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '产品属性分类表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `pms_product_attribute_value`  (
    ...
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 517 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '存储产品参数信息的表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `pms_product_category`  (
    ...
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 56 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '产品分类' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `pms_product_full_reduction`  (
    ...
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 148 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '产品满减表(只针对同商品)' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `pms_product_ladder`  (
    ...
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 148 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '产品阶梯价格表(只针对同商品)' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `pms_product_operate_log`  (
    ...
    `operate_man` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '操作人',
    `create_time` datetime DEFAULT NULL,
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '产品操作日志' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `pms_product_vertify_record`  (
    ...
    `product_id` bigint(20) DEFAULT NULL,
    `create_time` datetime DEFAULT NULL,
    `vertify_man` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '审核人',
    `status` int(1) DEFAULT NULL,
    `detail` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '反馈详情',
    PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `pms_sku_stock`  (
    ...
    `sp_data` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '商品销售属性，json格式',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 243 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'sku的库存' ROW_FORMAT = DYNAMIC;
