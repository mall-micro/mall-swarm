...
var (
	...
	cachemallUsercenterUserIdPrefix     = "cache:mallUsercenter:user:id:"
	cachemallUsercenterUserMobilePrefix = "cache:mallUsercenter:user:mobile:"
)
...
func (m *defaultUserModel) Delete(ctx context.Context, session sqlx.Session, id int64) error {
	...
	mallUsercenterUserIdKey := fmt.Sprintf("%s%v", cachemallUsercenterUserIdPrefix, id)
	mallUsercenterUserMobileKey := fmt.Sprintf("%s%v", cachemallUsercenterUserMobilePrefix, data.Mobile)
	...
	}, mallUsercenterUserIdKey, mallUsercenterUserMobileKey)
	return err
}
func (m *defaultUserModel) FindOne(ctx context.Context, id int64) (*User, error) {
	mallUsercenterUserIdKey := fmt.Sprintf("%s%v", cachemallUsercenterUserIdPrefix, id)
	var resp User
	err := m.QueryRowCtx(ctx, &resp, mallUsercenterUserIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultUserModel) FindOneByMobile(ctx context.Context, mobile string) (*User, error) {
	mallUsercenterUserMobileKey := fmt.Sprintf("%s%v", cachemallUsercenterUserMobilePrefix, mobile)
	var resp User
	err := m.QueryRowIndexCtx(ctx, &resp, mallUsercenterUserMobileKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultUserModel) Insert(ctx context.Context, session sqlx.Session, data *User) (sql.Result, error) {
	...
	mallUsercenterUserIdKey := fmt.Sprintf("%s%v", cachemallUsercenterUserIdPrefix, data.Id)
	mallUsercenterUserMobileKey := fmt.Sprintf("%s%v", cachemallUsercenterUserMobilePrefix, data.Mobile)
...
func (m *defaultUserModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cachemallUsercenterUserIdPrefix, primary)
}
