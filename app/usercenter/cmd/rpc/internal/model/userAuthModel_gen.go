...
var (
	...
	cachemallUsercenterUserAuthIdPrefix              = "cache:mallUsercenter:userAuth:id:"
	cachemallUsercenterUserAuthAuthTypeAuthKeyPrefix = "cache:mallUsercenter:userAuth:authType:authKey:"
	cachemallUsercenterUserAuthUserIdAuthTypePrefix  = "cache:mallUsercenter:userAuth:userId:authType:"
)
...
func (m *defaultUserAuthModel) Delete(ctx context.Context, session sqlx.Session, id int64) error {
	...
	mallUsercenterUserAuthAuthTypeAuthKeyKey := fmt.Sprintf("%s%v:%v", cachemallUsercenterUserAuthAuthTypeAuthKeyPrefix, data.AuthType, data.AuthKey)
	mallUsercenterUserAuthIdKey := fmt.Sprintf("%s%v", cachemallUsercenterUserAuthIdPrefix, id)
	mallUsercenterUserAuthUserIdAuthTypeKey := fmt.Sprintf("%s%v:%v", cachemallUsercenterUserAuthUserIdAuthTypePrefix, data.UserId, data.AuthType)
	...
	}, mallUsercenterUserAuthAuthTypeAuthKeyKey, mallUsercenterUserAuthIdKey, mallUsercenterUserAuthUserIdAuthTypeKey)
	return err
}
func (m *defaultUserAuthModel) FindOne(ctx context.Context, id int64) (*UserAuth, error) {
	mallUsercenterUserAuthIdKey := fmt.Sprintf("%s%v", cachemallUsercenterUserAuthIdPrefix, id)
	var resp UserAuth
	err := m.QueryRowCtx(ctx, &resp, mallUsercenterUserAuthIdKey, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) error {
...
func (m *defaultUserAuthModel) FindOneByAuthTypeAuthKey(ctx context.Context, authType string, authKey string) (*UserAuth, error) {
	mallUsercenterUserAuthAuthTypeAuthKeyKey := fmt.Sprintf("%s%v:%v", cachemallUsercenterUserAuthAuthTypeAuthKeyPrefix, authType, authKey)
	var resp UserAuth
	err := m.QueryRowIndexCtx(ctx, &resp, mallUsercenterUserAuthAuthTypeAuthKeyKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultUserAuthModel) FindOneByUserIdAuthType(ctx context.Context, userId int64, authType string) (*UserAuth, error) {
	mallUsercenterUserAuthUserIdAuthTypeKey := fmt.Sprintf("%s%v:%v", cachemallUsercenterUserAuthUserIdAuthTypePrefix, userId, authType)
	var resp UserAuth
	err := m.QueryRowIndexCtx(ctx, &resp, mallUsercenterUserAuthUserIdAuthTypeKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v interface{}) (i interface{}, e error) {
...
func (m *defaultUserAuthModel) Insert(ctx context.Context, session sqlx.Session, data *UserAuth) (sql.Result, error) {
	...
	mallUsercenterUserAuthAuthTypeAuthKeyKey := fmt.Sprintf("%s%v:%v", cachemallUsercenterUserAuthAuthTypeAuthKeyPrefix, data.AuthType, data.AuthKey)
	mallUsercenterUserAuthIdKey := fmt.Sprintf("%s%v", cachemallUsercenterUserAuthIdPrefix, data.Id)
	mallUsercenterUserAuthUserIdAuthTypeKey := fmt.Sprintf("%s%v:%v", cachemallUsercenterUserAuthUserIdAuthTypePrefix, data.UserId, data.AuthType)
...
func (m *defaultUserAuthModel) formatPrimary(primary interface{}) string {
	return fmt.Sprintf("%s%v", cachemallUsercenterUserAuthIdPrefix, primary)
}
